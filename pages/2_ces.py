...
if uploaded_file:
    ...
    if selected_columns:
        ...
        for col in selected_columns:
            ...
            satisfied = col_data[col_data >= 5].shape[0]
        ...
        satisfied_all = df_numeric[selected_columns].apply(lambda x: (x >= 5).sum()).sum()
        ...
        with pd.ExcelWriter(output, engine="openpyxl") as writer:
            results_df.to_excel(writer, index=False, sheet_name="CES Results")
